...
(function(){
  'use strict';
  window.EASYSTORE_VERSION = 'ES24 V1867 Dept Invoice Rows';
  ...
  function setVersion(){
    ...
    document.querySelectorAll('.version-badge,.version,.app-version').forEach(function(el){ el.textContent='ES24 V1867 Dept Invoice Rows'; });
    document.querySelectorAll('h1,h2,.brand h1,.top h1,.topbar h2').forEach(function(el){
